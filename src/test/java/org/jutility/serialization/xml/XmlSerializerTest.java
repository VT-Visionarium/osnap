...
public class XmlSerializerTest {
    ...
    public static void main(String[] args)
        ...
        layout.addLayoutProviderForVisualProperty(provider,
                edu.vt.arc.vis.osnap.visualization.VisualProperty.NODE_X_POSITION);
        layout.addLayoutProviderForVisualProperty(provider,
                edu.vt.arc.vis.osnap.visualization.VisualProperty.NODE_Y_POSITION);
        // layout.addLayoutProviderForVisualProperty(provider,
        // edu.vt.arc.vis.osnap.visualization.VisualProperty.NODE_Z_POSITION);

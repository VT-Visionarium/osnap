...
import static graphVisualizer.conversion.prefuse.Constants.PREFUSE_GROUP;
    ...
    public void layout(IPrefuseLayoutComponent layoutComponent,
        ...
        if (graph != null) {
            ...
            if (this.continueLayout) {
                ...
                try {
                    engine.convert(vis,
                            graphVisualizer.visualization.Visualization.class);
                }
        ...
        if (layoutComponent instanceof IPrefuseTreeLayoutComponent
            ...
            while (it.hasNext()) {
                ...
                if (object instanceof Node) {
                    ...
                    if (node.canGetString(graphVisualizer.conversion.prefuse.Constants.ID)) {
                        String id = node
                                .getString(graphVisualizer.conversion.prefuse.Constants.ID);

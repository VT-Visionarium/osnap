...
public abstract class BasePrefuseCoordinateLayoutComponent
     ...
     *
     * @see
     * graphVisualizer.layout.prefuseComponents.IPrefuseLayoutComponent#setDuration
     * (long)
     */
    @Override
     ...
     *
     * @see
     * graphVisualizer.layout.prefuseComponents.IPrefuseLayoutComponent#getDuration
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see graphVisualizer.layout.prefuseComponents.IPrefuseLayoutComponent#
     ...
     *
     * @see
     * graphVisualizer.layout.prefuseComponents.IPrefuseLayoutComponent#setMargin
     * (int, int, int, int)
     */
    @Override
     ...
     *
     * @see
     * graphVisualizer.layout.prefuseComponents.IPrefuseLayoutComponent#getTopMargin
     * ()
     */
    @Override

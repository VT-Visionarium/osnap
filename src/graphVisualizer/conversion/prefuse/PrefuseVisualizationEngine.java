...
public class PrefuseVisualizationEngine
    ...
    private graphVisualizer.visualization.Visualization visualization;
    ...
    public boolean supportsConversion(Class<?> sourceType, Class<?> targetType) {
        ...
        if (!targetType
                .isAssignableFrom(graphVisualizer.visualization.Visualization.class)) {
     ...
     *            {@link graphVisualizer.visualization.Visualization
     *            visualization}.
     */
     ...
     *            visualization}.
     * @param visualization
     *            the {@link graphVisualizer.visualization.Visualization
     *            visualization} to modify.
     */
    public PrefuseVisualizationEngine(IPrefuseLayoutComponent layoutComponent,
            graphVisualizer.visualization.Visualization visualization) {
    ...
    private graphVisualizer.visualization.Visualization convert(
            Visualization vis)
            throws ConversionException {
    ...
    private void createVisualization(Visualization vis)
        ...
        if (tuple instanceof Graph) {
            ...
            this.visualization = new graphVisualizer.visualization.Visualization(
                    universe);
        }
        else {
...
//                            + y + " for visual node " + visualNode.getID());
    ...
    private String getID(Tuple tuple)
        ...
        throw new ConversionException(
                "Node does not contain graphVisualizer identifier! "

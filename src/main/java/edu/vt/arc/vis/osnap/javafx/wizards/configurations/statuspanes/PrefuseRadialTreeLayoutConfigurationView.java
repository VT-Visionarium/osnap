...
/**
 * The {@code PrefuseRadialTreeLayout} class provides a status panes for
 * {@link PrefuseRadialTreeLayoutConfiguration PrefuseRadialTreeConfigurations}.
 *
...
public class PrefuseRadialTreeLayoutConfigurationView
     ...
     * {@code PrefuseRadialTreeLayoutConfigurationView} class.
     *
     * @param title
    ...
    public PrefuseRadialTreeLayoutConfigurationView(final String title) {
        ...
        this.radiusIncrementLabel.setLabelFor(this.radiusIncrementValue);

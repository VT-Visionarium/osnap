...
/**
 * The abstract {@link Base2DCoordinateLayout} class provides a base
 * implementation of the {@link I2DCoordinateLayout} interface.
 * 
 * @author Peter J. Radics
 * @version 1.2.0
 * @since 0.1.0
 */
@XmlType(name = "Base2DCoordinateLayout")
public abstract class Base2DCoordinateLayout
        extends BaseCoordinateLayout
        implements I2DCoordinateLayout {
     ...
     * VisualProperties} that can be provided) by this {@link ILayout}.
     * 
    ...
    /**
     * Creates a new instance of the {@link Base2DCoordinateLayout} class that
     * routes the first {@link CoordinateComponent component} to the x
     * coordinate and the second {@link CoordinateComponent component} to the y
     * coordinate.
     */
    public Base2DCoordinateLayout() {
     ...
     */
    public Base2DCoordinateLayout(String name, String description,
            boolean randomize) {
    ...
    /**
     * Creates a new instance of the {@link Base2DCoordinateLayout} class with
     ...
     *            coordinate.
     */
    public Base2DCoordinateLayout(CoordinateComponent xOutput,
            CoordinateComponent yOutput, CoordinateComponent zOutput) {

        this(xOutput, yOutput, zOutput, Base2DCoordinateLayout.name(),
                Base2DCoordinateLayout.description(), true);
     ...
     *            serialization.
     */
    protected Base2DCoordinateLayout(CoordinateComponent xOutput,
            CoordinateComponent yOutput, CoordinateComponent zOutput,
            String name, String description, boolean randomize,
            boolean serialization) {

        super(Base2DCoordinateLayout.components(), xOutput, yOutput, zOutput,

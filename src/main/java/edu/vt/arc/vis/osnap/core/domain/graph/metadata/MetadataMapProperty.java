...
/**
 * The {@code MetadataMapProperty} class provides a container for
...
public class MetadataMapProperty
    ...
    /**
     * Returns the {@code Schema} adhered to.
     *
     * @return the schema.
     */
    ...
    /**
     * Creates a new instance of the {@code MetadataMapProperty} class. Used for
     * XML Serialization.
     * 
     */
    ...
    /**
     * Creates a new instance of the {@code MetadataMapProperty} class adhering
     * to the provided {@link Schema}.
     *
     * @param schema
     *            the {@code Schema} to adhere to.
     */
     ...
     *
     * @param toCopy
     *            the {@code MetadataMapProperty} to copy.
     */
    ...
    /**
     * Creates a new instance of the {@link MetadataMapProperty} class from the
     * provided details.
     * 
     * @param details
     *            the details.
     */
    public MetadataMapProperty(final MetadataPropertyDetails details) {

        super(details);

        this.schema = Schema.fromDetails(details.getSchema());

        this.metadata = new LinkedHashMap<>();

        if (details.getMetadata() != null && !details.getMetadata().isEmpty()) {

            for (MetadataDetails entry : details.getMetadata()) {

                this.addMetadata(Metadata.fromDetails(entry));
            }
        }
    ...
    /**
     * Returns the keys of the {@code Metadata} stored.
     *
     * @return the keys.
     */
     ...
     * @param key
     *            the key.
     * @return a list of {@link Metadata} or {@code null}, if the key is not
     ...
     * @param key
     *            the key.
     * @return {@code true}, if an entry exists for the key; {@code false}
     *         otherwise.
     */
     ...
     * @param metadata
     *            the metadata.
     * @return {@code true}, if the entry exists in the container; {@code false}
     *         otherwise.
     */
    ...
    /**
     * Returns a deep copy of this {@code MetadataMapProperty}.
     *
    ...
    /**
     * Returns whether or not this {@code MetadataMapProperty} is identical to
     * the one provided.
     * 
     * @param other
     *            the other {@code MetadataMapProperty}.
     * @return {@code true}, if the instances are identical; {@code false}
     *         otherwise.
     */
    ...
    @Override
    public MetadataPropertyDetails toDetails() {

        MetadataPropertyDetails details = new MetadataPropertyDetails(
                super.toDetails());

        details.setSchema(this.getSchema().toDetails());


        if (!this.metadata.isEmpty()) {

            details.setMetadata(new ArrayList<>());

            for (Metadata metadata : this.getMetadata()) {

                details.getMetadata().add(metadata.toDetails());
            }
    ...
    /**
     * Returns a {@link MetadataMapProperty} corresponding to the provided
     * details.
     * 
     * @param details
     *            the details.
     * @return a {@link MetadataMapProperty} corresponding to the provided
     *         details.
     */
    public static MetadataMapProperty fromDetails(
            final MetadataPropertyDetails details) {

        return new MetadataMapProperty(details);
    }
}

...
/**
 * The {@code PrefuseFruchtermanReingoldLayoutWizard} provides a wizard for
 * creating the {@link PrefuseFruchtermanReingoldLayoutConfiguration
 * Configuration} of the {@link PrefuseFruchtermanReingoldLayout}.
 * 
...
public class PrefuseFruchtermanReingoldLayoutWizard
	 ...
	 * {@code PrefuseFruchtermanReingoldLayoutWizard} class.
	 * 
	 * @param owner
	 ...
	 */
	public PrefuseFruchtermanReingoldLayoutWizard(Stage owner, Universe universe) {
	 ...
	 *            {@link ILayoutConfiguration LayoutConfiguration} is created.
	 */
	public PrefuseFruchtermanReingoldLayoutWizard(Window owner,
			Universe universe) {

		super(owner, "Configure " + PrefuseFruchtermanReingoldLayout.name(),
				universe);

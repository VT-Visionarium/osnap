...
/**
 * The {@code PrefuseBalloonTreeLayoutWizard} provides a wizard for creating the
 * {@link PrefuseBalloonTreeLayoutConfiguration Configuration} of the
 ...
 * @since 0.5.0
 */
public class PrefuseBalloonTreeLayoutWizard
        extends
        LayoutConfigurationWizard<PrefuseBalloonTreeLayout, PrefuseBalloonTreeLayoutConfiguration> {
     ...
     *            {@link ILayoutConfiguration LayoutConfiguration} is created.
     */
    public PrefuseBalloonTreeLayoutWizard(Window owner, Universe universe) {

        super(owner, "Configure " + PrefuseBalloonTreeLayout.name(), universe);

        this.configurationView = new PrefuseBalloonTreeLayoutConfigurationView(
                "Configuration");
        WizardPane page1 = new CapabilitySelectionPage<>(
                this.configurationView, PrefuseBalloonTreeLayout.capabilities());
    ...
    @Override
    public PrefuseBalloonTreeLayoutConfiguration getConfiguration() {

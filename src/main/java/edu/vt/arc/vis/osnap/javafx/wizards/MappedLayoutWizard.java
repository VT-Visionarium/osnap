...
public class MappedLayoutWizard
	 ...
	 */
	public MappedLayoutWizard(Stage owner, Universe universe) {
	...
	public MappedLayoutWizard(Window owner, Universe universe) {
		...
		WizardPane page1 = new CapabilitySelectionPage<>(this.configurationView);

		WizardPane page2 = new GraphObjectSelectionPage<>(
				this.configurationView, universe);

		WizardPane page3 = new DomainKeyValueSelectionPage(

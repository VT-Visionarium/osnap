...
public abstract class BasePrefuseCoordinateLayoutComponent
     ...
     *
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.prefuseComponents.IPrefuseLayoutComponent#setDuration
     * (long)
     */
    @Override
     ...
     *
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.prefuseComponents.IPrefuseLayoutComponent#getDuration
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see edu.vt.arc.vis.osnap.core.domain.layout.prefuseComponents.IPrefuseLayoutComponent#
     ...
     *
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.prefuseComponents.IPrefuseLayoutComponent#setMargin
     * (int, int, int, int)
     */
    @Override
     ...
     *
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.prefuseComponents.IPrefuseLayoutComponent#getTopMargin
     * ()
     */
    @Override

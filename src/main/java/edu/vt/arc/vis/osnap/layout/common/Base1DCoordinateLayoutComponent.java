...
public abstract class Base1DCoordinateLayoutComponent
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.layout.common.BaseLayoutComponent#enable(edu.vt.arc.vis.osnap
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.layout.common.BaseLayoutComponent#disable(edu.vt.arc.vis.osnap
     * .visualization.VisualProperty)
     */
    @Override

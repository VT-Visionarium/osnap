 ...
 *
 */
package edu.vt.arc.vis.osnap.conversion.prefuse;
...
import edu.vt.arc.vis.osnap.layout.prefuseComponents.IPrefuseLayoutComponent;
...
public class PrefuseVisualizationEngine
    ...
    private edu.vt.arc.vis.osnap.visualization.Visualization visualization;
    ...
    public boolean supportsConversion(Class<?> sourceType, Class<?> targetType) {
        ...
        if (!targetType
                .isAssignableFrom(edu.vt.arc.vis.osnap.visualization.Visualization.class)) {
     ...
     *            {@link edu.vt.arc.vis.osnap.visualization.Visualization
     *            visualization}.
     */
     ...
     *            visualization}.
     * @param visualization
     *            the {@link edu.vt.arc.vis.osnap.visualization.Visualization
    ...
    private edu.vt.arc.vis.osnap.visualization.Visualization convert(
            Visualization vis)
            throws ConversionException {
    ...
    private void createVisualization(Visualization vis)
        ...
        if (tuple instanceof Graph) {
            ...
            this.visualization = new edu.vt.arc.vis.osnap.visualization.Visualization(
                    universe);
        }
        else {
...
//                            + y + " for visual node " + visualNode.getID());
    ...
    private String getID(Tuple tuple)
        ...
        throw new ConversionException(
                "Node does not contain edu.vt.arc.vis.osnap identifier! "

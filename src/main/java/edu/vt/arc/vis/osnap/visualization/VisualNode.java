 ...
 * @version 0.1
 * 
 * @see edu.vt.arc.vis.osnap.visualization.VisualGraph
 * @see edu.vt.arc.vis.osnap.visualization.VisualEdge
 * @see edu.vt.arc.vis.osnap.visualization.VisualHyperEdge

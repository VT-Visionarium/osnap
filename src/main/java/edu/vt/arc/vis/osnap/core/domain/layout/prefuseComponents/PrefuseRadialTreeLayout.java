...
/**
 * The {@code PrefuseRadialTreeLayout} class computes a radial layout, laying
 * out subsequent depth levels of a tree on circles of progressively increasing
 * radiusIncrement.
 * 
 ...
 * 
 */
@XmlType(name = "PrefuseRadialTreeLayout")
public class PrefuseRadialTreeLayout
    ...
    public static String name() {
        ...
        return "Radial Tree Layout (Prefuse)";
    }
    ...
    public static String description() {
        ...
        String description = "The " + PrefuseRadialTreeLayout.name()
    ...
    /**
     * Creates a new instance of the {@link PrefuseRadialTreeLayout} class.
     * (Serialization Constructor).
     */
    @SuppressWarnings("unused")
    private PrefuseRadialTreeLayout() {

        this(null, 50, true);
    }

    /**
     * Creates a new instance of the {@link PrefuseRadialTreeLayout} class with
     * the provided {@link INode Node} as root of the tree.
     * 
     * @param rootNode
     *            the root node.
     */
    public PrefuseRadialTreeLayout(INode rootNode) {
     ...
     *            the radiusIncrement.
     */
    public PrefuseRadialTreeLayout(INode rootNode, int radiusIncrement) {
    ...
    public PrefuseRadialTreeLayout(INode rootNode, int radiusIncrement,
        ...
        super(PrefuseRadialTreeLayout.name(), PrefuseRadialTreeLayout

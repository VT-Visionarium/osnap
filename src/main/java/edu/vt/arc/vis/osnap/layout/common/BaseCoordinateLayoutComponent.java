...
public abstract class BaseCoordinateLayoutComponent
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.layout.complexComponents.common.ICoordinateLayoutComponent
     * #providesComponents()
     */
    @Override
     ...
     * @see
     * edu.vt.arc.vis.osnap.layout.complexComponents.common.ICoordinateLayoutComponent
     * #setXOutput(edu.vt.arc.vis.osnap .layout.common.OutputComponent)
     */
    @Override
     ...
     * @see
     * edu.vt.arc.vis.osnap.layout.complexComponents.common.ICoordinateLayoutComponent
     * #setYOutput(edu.vt.arc.vis.osnap .layout.common.OutputComponent)
     */
    @Override
     ...
     * @see
     * edu.vt.arc.vis.osnap.layout.complexComponents.common.ICoordinateLayoutComponent
     * #setZOutput(edu.vt.arc.vis.osnap .layout.common.OutputComponent)
     */
    @Override

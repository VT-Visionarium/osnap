...
/**
 * The {@code ILayout} interface provides a contract for classes that
 * provide layout options for {@link VisualProperty VisualProperties}.
 * 
 * @see VisualProperty
 * @see Visualization
 * @see VisualGraph
...
public interface ILayout {
    ...
    /**
     * Sets the name of this {@link ILayout}.
     * 
     * @param name
     *            the name.
     */
    ...
    /**
     * Sets the description of this {@link ILayout}.
     * 
     * @param description
     *            the description.
     */
     ...
     * @return {@code true}, if the {@link VisualProperty} is to be applied;
    ...
    /**
     * Returns whether or not this {@link ILayout} will make any
     * changes to the {@link Visualization} when calling layout.
     * 
     * @return {@code true}, if the this {@link ILayout} will make
     *         changes to the {@link Visualization}; {@code false} otherwise.
     */
     ...
     * 
     * @return {@code true}, if the provider will make changes; {@code false}
     *         otherwise.
     */
    ...
    /**
     * Applies this {@link ILayout ILayout'scale}
    ...
    /**
     * Returns whether or not this {@link ILayout} is restricted to a
     * certain set of {@link IGraphObject IGraphObjects}.
     * 
     * @return {@code true}, if this {@link ILayout} is restricted;
     *         {@code false} otherwise.
     */
    ...
    /**
     * Returns the restriction of this {@link ILayout}, i.e., the set
    ...
    /**
     * Sets the restriction of this {@link ILayout}, i.e., the set of
    ...
    /**
     * Clears the restriction of this {@link ILayout}, i.e., the set of
     * {@link IGraphObject IGraphObjects} it applies to.
     */

 ...
 * 
 */
@XmlSchema(namespace = "edu.vt.arc.vis.osnap.layout.simpleComponents", xmlns = { @XmlNs(namespaceURI = "edu.vt.arc.vis.osnap.layout.simpleComponents", prefix = "simpleComponents") })

...
import edu.vt.arc.vis.osnap.graph.common.*;
...
public abstract class UniverseBase
     ...
     * 
     * The hyperedge map maps a hyperedge'scale id to the actual hyperedge for quick
     * access.
     * 
     ...
     *            the graph to delete.
     */
    protected void deleteGraph(IGraph graph) {

...
/**
 * The {@code PrefuseNodeLinkTreeLayout} class computes a tidy layout of a
 * node-link tree diagram. This algorithm lays out a rooted tree such that each
 * depth level of the tree is on a shared line. The orientation of the tree can
 * be set such that the tree goes left-to-right (default), right-to-left,
 ...
 * @since 0.1.0
 */
@XmlType(name = "PrefuseNodeLinkTreeLayout")
public class PrefuseNodeLinkTreeLayout
    ...
    public static String name() {
        ...
        return "Node Link Tree Layout (Prefuse)";
    }
    ...
    public static String description() {
        ...
        String description = "The "
                + PrefuseNodeLinkTreeLayout.name()
    ...
    /**
     * Creates a new instance of the {@link PrefuseNodeLinkTreeLayout} class.
     * (Serialization Constructor).
     */
    @SuppressWarnings("unused")
    private PrefuseNodeLinkTreeLayout() {
    ...
    /**
     * Creates a new instance of the {@link PrefuseNodeLinkTreeLayout} class
     * with the provided {@link INode Node} as root of the tree.
     * 
     * @param rootNode
     *            the root node.
     */
    public PrefuseNodeLinkTreeLayout(INode rootNode) {
    ...
    /**
     * Creates a new instance of the {@link PrefuseNodeLinkTreeLayout} class
     * with the provided {@link INode Node} as root of the tree and the provided
     * orientation, depth spacing, space between siblings and neighboring
     * subtrees.
     * 
     * @param rootNode
     *            the root node.
     ...
     */
    public PrefuseNodeLinkTreeLayout(INode rootNode, Orientation orientation,
            double depthSpacing, double spaceBetweenSiblings,
            double spaceBetweenNeighboringSubtrees) {

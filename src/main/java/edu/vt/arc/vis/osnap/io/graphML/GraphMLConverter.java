...
package edu.vt.arc.vis.osnap.io.graphML;
...
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.DoubleMetadata;
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.FloatMetadata;
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.IMetadataContainer;
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.IntegerMetadata;
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.LongMetadata;
...
import edu.vt.arc.vis.osnap.core.domain.graph.metadata.StringMetadata;
...
public final class GraphMLConverter
    ...
    private void parseGraphMLDocument(GraphMLDocument graphMLDocument,
        ...
        for (Graph graphMLGraph : graphMLDocument.getGraphs()) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Graph graph = universe.createGraph(id);
    ...
    private void parseGraphMLGraph(Graph graphMLGraph,
            edu.vt.arc.vis.osnap.core.domain.graph.Graph graph)
            throws ConversionException {
        ...
        for (Node graphMLNode : nodes) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Node node = graph.getUniverse().createNode(
        ...
        for (Edge graphMLEdge : edges) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Edge edge = graph.getUniverse().createEdge(
     ...
     * @throws ConversionException
     */
    private void parsePort(Port port, edu.vt.arc.vis.osnap.core.domain.graph.Node node,
            String parentName)
            throws ConversionException {
    ...
    private void parseGraphMLNode(Node graphMLNode,
            edu.vt.arc.vis.osnap.core.domain.graph.Node node)
            throws ConversionException {
        ...
        if (subGraph != null) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Graph graph = node.getGraph().getUniverse()
                    .createGraph(id);
    ...
    private void parseGraphMLEdge(Edge graphMLEdge,
            edu.vt.arc.vis.osnap.core.domain.graph.Edge edge)
            throws ConversionException {
        ...
        if (subGraph != null) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Graph graph = edge.getGraph().getUniverse()
                    .createGraph(id);
    ...
    /**
     * Parses an EndpointBaseDetails into its containing HyperEdge.
     * 
     ...
     * 
     * @param endpoint
     *            The EndpointBaseDetails to parse.
     * @param hyperEdge
    ...
    private void parseGraphMLHyperedge(Hyperedge graphMLHyperEdge,
        ...
        if (subGraph != null) {
            ...
            edu.vt.arc.vis.osnap.core.domain.graph.Graph graph = hyperEdge.getGraph()

...
public abstract class BaseLayoutComponent
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#getName()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#setName(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#getDescription()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#setDescription(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#isRestricted()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#getRestriction()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#setRestriction(java.util
     * .Set)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#clearRestriction()
     */
    @Override
     ...
     * {@link edu.vt.arc.vis.osnap.core.domain.layout.Layout} when the provider is assigned to a
     * specific {@link edu.vt.arc.vis.osnap.core.domain.visualization.VisualProperty}.
     * 
     * @param capabilities
     *            the set of
     ...
     * {@link edu.vt.arc.vis.osnap.core.domain.layout.Layout} when the provider is assigned to a
     * specific {@link edu.vt.arc.vis.osnap.core.domain.visualization.VisualProperty}. It sets
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#providesCapabilities()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#enable(edu.vt.arc.vis.osnap.core
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#isEnabled(edu.vt.arc.vis.osnap.core
     * .visualization.VisualProperty)
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#disable(edu.vt.arc.vis.osnap.core
     * .visualization.VisualProperty)
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#modifiesVisualization()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#modifiesVisualNodes()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#modifiesVisualEdges()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ILayoutComponent#modifiesVisualHyperEdges()
     */
    @Override

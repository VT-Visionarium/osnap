 ...
 * @since 0.1.0
 */
@XmlSeeAlso({BaseMappedLayout.class, MappedColorLayout.class, MappedCoordinateLayout.class, MappedLabelTextLayout.class, MappedScaleLayout.class, MappedShapeLayout.class})

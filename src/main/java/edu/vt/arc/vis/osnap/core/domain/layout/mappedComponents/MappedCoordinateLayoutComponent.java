...
import edu.vt.arc.vis.osnap.core.domain.layout.common.Base1DCoordinateLayoutComponent;
...
public class MappedCoordinateLayoutComponent<DOMAIN_KEY_TYPE extends IGraphObjectBasedValueTypeContainer, DOMAIN_VALUE_TYPE>
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#providesComponents
     * ()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#getXOutput()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#getYOutput()
     */
    @Override
     ...
     * 
     * @see
     * edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#getZOutput()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#setXOutput(
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#setZOutput(
     * edu.vt.arc.vis.osnap.core.domain.layout.common.CoordinateComponent)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#setValue(
     * edu.vt.arc.vis.osnap.core.domain.visualization.VisualNode,
     * edu.vt.arc.vis.osnap.core.domain.layout.common.CoordinateComponent, java.lang.Float)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.core.domain.layout.common.ICoordinateLayoutComponent#getValue(
     * edu.vt.arc.vis.osnap.core.domain.visualization.VisualNode,
     * edu.vt.arc.vis.osnap.core.domain.layout.common.CoordinateComponent)
     */
    @Override

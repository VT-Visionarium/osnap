...
public class IOManager implements IConverter, ISerializer {
	...
	public <S> S open(URI uri, Class<? extends S> returnType) {
		...
		try {
			...
			edlg.setTitle("Could Not Recognize Content Type!");
			edlg.showAndWait();
			return null;
		}
		...
		try {
			...
			ExceptionDialog edlg = new ExceptionDialog(e);
			edlg.setTitle("Could Not Deserialize Object!");
			edlg.showAndWait();
			return null;
		}
		...
		try {
			...
			ExceptionDialog edlg = new ExceptionDialog(e);
			edlg.setTitle("Could Not Convert Object!");
			edlg.showAndWait();
	...
	public <S, T> boolean save(File file, S objectToSave,
		...
		if (serializableObject != null) {
			...
			try {
				...
				alert.setContentText("File was successfully saved to "
						+ file.getAbsolutePath() + "!");
				alert.showAndWait();
			} catch (SerializationException e) {

				ExceptionDialog edlg = new ExceptionDialog(e);
				edlg.setTitle("Could Not Serialize Object to "
						+ file.getAbsolutePath() + "!");
				edlg.showAndWait();
			...
			alert.setTitle("Could Not Serialize Object");
			alert.setContentText("Could Not Serialize Object to "
					+ file.getAbsolutePath()

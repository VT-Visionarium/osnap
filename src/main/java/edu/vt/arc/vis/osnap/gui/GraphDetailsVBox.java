...
import edu.vt.arc.vis.osnap.gui.dialogs.EdgeDialog;
import edu.vt.arc.vis.osnap.gui.dialogs.EdgePropertiesDialog;
import edu.vt.arc.vis.osnap.gui.dialogs.GraphDialog;
import edu.vt.arc.vis.osnap.gui.dialogs.GraphPropertiesDialog;
import edu.vt.arc.vis.osnap.gui.dialogs.NodeDialog;
import edu.vt.arc.vis.osnap.gui.dialogs.NodePropertiesDialog;
import edu.vt.arc.vis.osnap.gui.events.MetadataChangedEvent;
import edu.vt.arc.vis.osnap.gui.stringConverters.GraphObjectStringConverter;
import edu.vt.arc.vis.osnap.gui.stringConverters.GraphObjectStringConverterConfiguration;
import edu.vt.arc.vis.osnap.gui.widgets.MetaDataTable;
import edu.vt.arc.vis.osnap.gui.widgets.SchemaTableView;

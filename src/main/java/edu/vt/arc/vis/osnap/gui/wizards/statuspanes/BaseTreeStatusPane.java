...
import edu.vt.arc.vis.osnap.gui.wizards.statusobjects.ITreeStatus;
 ...
 *
 */
public abstract class BaseTreeStatusPane
     ...
     */
    public BaseTreeStatusPane(String lbl) {
     ...
     */
    @Override
    public void update(Observable changedObject, Object changedObjectProperty) {

        super.update(changedObject, changedObjectProperty);

        if (changedObject instanceof ITreeStatus) {
            ITreeStatus status = (ITreeStatus) changedObject;

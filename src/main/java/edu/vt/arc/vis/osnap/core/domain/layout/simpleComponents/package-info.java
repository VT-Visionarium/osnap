 ...
 * 
 */
@XmlSchema(namespace = "edu.vt.arc.vis.osnap.core.domain.layout.simpleComponents", xmlns = { @XmlNs(namespaceURI = "edu.vt.arc.vis.osnap.core.domain.layout.simpleComponents", prefix = "simpleComponents") })

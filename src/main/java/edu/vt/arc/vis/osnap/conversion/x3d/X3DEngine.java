...
package edu.vt.arc.vis.osnap.conversion.x3d;
...
import edu.vt.arc.vis.osnap.utils.x3d.scripts.KeyScriptFactory;
import edu.vt.arc.vis.osnap.utils.x3d.scripts.KeyScriptFactory.ActionKey;
import edu.vt.arc.vis.osnap.visualization.Label;
...
import x3d.model.X3DGeometryNode;
...
public class X3DEngine
     ...
     * (non-Javadoc)
     * 
     * @see edu.vt.arc.vis.osnap.conversion.IConverter#convert(java.lang.Object,
     * java.lang.Class)
     */
    @Override
    ...
    private X3DDocument convert(Visualization visualization) {
        ...
        for (Viewpoint viewpoint : visualization.getViewpoints()) {
            ...
            x3d.model.Viewpoint x3dViewpoint = new x3d.model.Viewpoint();
    ...
    private Shape createShape(edu.vt.arc.vis.osnap.visualization.Shape baseShape,
            Color color) {
